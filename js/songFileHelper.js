...
//        console.log(titleAndArtist);
        ...
        // Separate artist and original DVD ripped source if it exist.
        var artistAndSrc = artist.split('_');
        var artistClean =  artistAndSrc.length > 1 ? artistAndSrc[0] : artist;

        var songSrcNoDiacritics = this.removeDiacritics(songSrc);

        return { 'title' : title, 'artist' : artistClean, 'src' : songSrc, 'songSrcNoDiacritics' : songSrcNoDiacritics, 'class' : 'glyphicon-plus' };
        /*
        */
    }
}